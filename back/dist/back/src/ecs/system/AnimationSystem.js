...
export class AnimationSystem {
    ...
    isGrounded(positionComponent, colliderComponent, world) {
    ...
    updateState(inputComponent, stateComponent, isGrounded) {
    ...
    calculateRotation(inputComponent) {
        ...
        if (down && right)
            angle += Math.PI + Math.PI / 4;
        return new THREE.Quaternion().setFromAxisAngle(new THREE.Vector3(0, 1, 0), angle - lookingYAngle);
    }
    rotatePlayer(rigidBodyComponent, quaternion) {

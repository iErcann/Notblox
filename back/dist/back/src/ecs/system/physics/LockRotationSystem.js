...
export class LockRotationSystem {
    update(entities) {
        ...
        const removedEvents = EventSystem.getEventsWrapped(ComponentRemovedEvent, LockedRotationComponent);
    ...
    getDynamicBodyComponent(entity) {
...
//# sourceMappingURL=LockRotationSystem.js.map
...
export class GroundedCheckSystem {
    update(entities, world) {
        for (const entity of entities) {
            ...
            const colliderComponent = entity.getComponent(CapsuleColliderComponent) || entity.getComponent(BoxColliderComponent);
            if (groundedComponent && bodyComponent && positionComponent && colliderComponent) {
                ...
                const hit = world.castRay(ray, size * 2, false, undefined, undefined, colliderComponent.collider);
                groundedComponent.grounded = hit ? true : false;
            }
        }
    }
}
//# sourceMappingURL=GroundedCheckSystem.js.map
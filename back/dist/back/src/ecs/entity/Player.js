...
export class Player {
    entity;
    constructor(ws, initialX, initialY, initialZ) {
        ...
        const colorComponent = new ColorComponent(this.entity.id, `#${Math.floor(Math.random() * 16777215).toString(16)}`);
        ...
        const serverMeshComponent = new ServerMeshComponent(this.entity.id, 'https://rawcdn.githack.com/iErcann/Notblox-Assets/0ac6d49540b8fb924bef1b126fbdfd965d733c3a/Character.glb');

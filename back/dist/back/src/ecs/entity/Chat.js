...
export class Chat {
    ...
    constructor() {
        ...
        EventSystem.addEvent(new ChatMessageEvent(this.entity.id, '🖥️ [SERVER]', `Started ${new Date().toLocaleString()}`));
        EventSystem.addEvent(new ChatMessageEvent(this.entity.id, '🖥️ [SERVER]', 'Welcome to the chat !'));

...
export class EventSystem {
     ...
     */
    static getEvents(componentType) {
        const eventListComponent = EventSystem.getInstance().eventQueue.entity.getComponent(EventListComponent);
    ...
    static getEventsWrapped(eventType, componentType) {
        // Filtering by eventType (e.g., ComponentAddedEvent)
        const events = EventSystem.getEvents(eventType);
        // Then filtering by its wrapped component type
        const eventsWrapped = events.filter((event) => event.component instanceof componentType);
     ...
     */
    static onComponentAdded(addedComponent) {
     ...
     */
    static onComponentRemoved(removedComponent) {

...
import { NetworkGameObject } from "./gameobject";
...
export class NetworkCube extends Cube implements NetworkGameObject {
  public id: String;
  public nextPosition = new THREE.Vector3();
  public nextRotation = new THREE.Quaternion();

  constructor(id: String, size: number, color: number) {
    super(size, color);
    this.id = id;
  }

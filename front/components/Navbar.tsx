      ...
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex space-x-4">
          <a href="https://github.com/iErcann/Notblox" target="_blank" rel="noopener noreferrer">
            <Github className="h-6 w-6 text-gray-800 hover:text-gray-600" />
          </a>
          <a href="https://discord.gg/kPhgtj49U2" target="_blank" rel="noopener noreferrer">
            <Link className="h-6 w-6 text-gray-800 hover:text-gray-600" />
          ...
          <a href="https://twitter.com/iErcan_" target="_blank" rel="noopener noreferrer">
            <Twitter className="h-6 w-6 text-gray-800 hover:text-gray-600" />
          </a>
        </div>
      </div>
    </section>

...
export default function GameCard({ title, imageUrl, websocketPort, metaDescription }: GameInfo) {
  return (
    <a
      href="/test"
    ...
    >
      ...
      <div className="relative bg-gradient-to-t from-gray-900/50 to-gray-900/10 pt-32 sm:pt-48 lg:pt-64  ">
        <div className="p-4 sm:p-6">
          ...
          <p className="mt-2 line-clamp-3  text-sm/relaxed text-white/95">{metaDescription}</p>
        </div>
      </div>
    </a>
  )

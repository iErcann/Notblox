    ...
    >
      <div className="flex justify-between items-center">
        <div className="shadow-4xl p-4  rounded-lg space-y-1 bg-gray-800 bg-opacity-20">
          ...
          <a className="text-sm md:text-2xl font-bold pointer-events-auto hover:text-gray-400" href="/">
          ...
          <div className="space-x-4 text-sm flex justify-around  text-white pointer-events-auto">
            <a href="https://discord.gg/kPhgtj49U2" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">
              <svg
            ...
            <a href="https://twitter.com/iErcan_" target="_blank" rel="noopener noreferrer">
              <Twitter className="h-6 w-6 text-white hover:text-gray-600" />
            </a>
            <a href="https://github.com/iErcann/Notblox" target="_blank" rel="noopener noreferrer">

...
export default function GameHud({ chatList, sendMessage, gameInstance, toggleTransformControls, setTransformControlsMode }: GameHudProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-4 right-4 pointer-events-auto flex flex-col space-y-2">
        <button

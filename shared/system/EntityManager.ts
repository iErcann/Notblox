...
import { PositionUpdateMessage } from '../network/client/base'
import { DynamicRigidBodyComponent } from '../../back/src/ecs/component/physics/DynamicRigidBodyComponent.js'
...
export class EntityManager {
  ...
  static getEntityByMesh(mesh: THREE.Mesh): Entity | undefined {
